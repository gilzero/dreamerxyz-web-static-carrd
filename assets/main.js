...
(function() {
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('#image05', { style: 'fade-left', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		...
		onvisible.add('#text08', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text11', { style: 'fade-in', speed: 3000, intensity: 5, threshold: 3, delay: 1625, stagger: 500, staggerSelector: ':scope > *', replay: true });
